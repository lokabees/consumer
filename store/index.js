...
export const state = () => ({
  position: {
    selectedMapPosition: {
      ...
      zoom: 12,
      name: null,
      swLatitude: 52.43612521749256,
      swLongitude: 13.249394224697085,
      neLatitude: 52.593916913351194,
      neLongitude: 13.52497038246193,
      southwestgeohash: 'u336m3xyt',
      northeastgeohash: 'u33e5y2tf',
    },
  },
  locales: [
    {
